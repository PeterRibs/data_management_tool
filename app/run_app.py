...
App('initialData.txt', columnsName, 'db_test', User, Password, host).all_process(columnsNameGeneral, columnsNameCNPJ)

### To consult the table, just uncomment the lines below:
